...
fn main() {
    ...
    println!("cargo::rustc-check-cfg=cfg(libva_1_17_or_higher)");
    println!("cargo::rustc-check-cfg=cfg(libva_1_18_or_higher)");
    ...
    println!("cargo::rustc-check-cfg=cfg(libva_1_22_or_higher)");
